...
\newcommand{\zhtitle}{3/2波动率模型期权定价新方法与比较分析}
% 英文标题 (使用 \enquote{} 输入英文引号)
\newcommand{\entitle}{New Methods for Option Pricing Based on the 3/2 Volatility Model and Comparative Analysis}
...
% 格式: 姓名 + 两个空格 + 职称
% 职称: 教授 / 副教授 / 讲师 / 助理教授
\newcommand{\zhmentorname}{Domenico Tarzia\ \ 助理教授}
% 英文格式: Prof. / A.P. (Associate Professor) / Lec. (Lecturer)
\newcommand{\enmentorname}{Asst.\ Prof.\ Domenico Tarzia}
