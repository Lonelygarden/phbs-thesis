...
\newcommand{\zhtitle}{3/2波动率模型下的期权精确定价：多方法比较与极端场景下的新框架}
% 英文标题 (使用 \enquote{} 输入英文引号)
\newcommand{\entitle}{Precision Option Pricing under the 3/2 Volatility Model: A Multi-Method Comparison and a Novel Framework for Extreme Scenarios}
