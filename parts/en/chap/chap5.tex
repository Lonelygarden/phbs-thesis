...
The time-stepping methods comprise 4 schemes: Euler/Milstein discretization scheme, Exact Stepping, Poisson-Gamma Near-Exact Stepping, and QE Near-Exact Stepping. The experiment configures 3 sets of time step sizes, $dt = 1/50, 1/500, \text{ and } 1/5000$, representing a progression from coarse to fine time discretization precision to examine the impact of step size on method performance. The full results are presented in Table \ref{tab:timestepping_part1}, Table \ref{tab:timestepping_part2}, Table \ref{tab:almostexactstepping_part1}, Table \ref{tab:almostexactstepping_part2}.
...
\begin{table}[htbp]
  \centering
  \caption{Almost Exact Stepping Results (CaseI-IV)}
  \label{tab:almostexactstepping_part1}
  \resizebox{\textwidth}{!}{%
  \begin{tabular}{lclclclc}
    \toprule
    \multirow{2}{*}{Case} & \multirow{2}{*}{$dt$} & \multirow{2}{*}{Strike} 
    & \multicolumn{2}{c}{Almost Exact Stepping (Poison-Gamma)} 
    & \multicolumn{2}{c}{Almost Exact Stepping (QE)} \\
    \cmidrule(lr){4-5} \cmidrule(lr){6-7}
    & & & Time (s) & Option Bias & Time (s) & Option Bias \\
    \midrule
    \multirow{3}{*}{Case I}
    & 1/50   & 1 & 0.6209759    & $-0.0005159$ ($-0.12\%$)     & 0.6758925     & $-0.0002905$ ($-0.07\%$)  \\
    & 1/500  & 1 & 5.5486124    & $-0.0004362$ ($-0.10\%$)     & 6.660179      & $-0.0002077$ ($-0.05\%$)  \\
    & 1/5000 & 1 & 88.8646271   & $-8.395e-05$ ($-0.02\%$)     & 101.9920107   & $-0.0001411$ ($-0.03\%$)  \\
    \midrule
    \multirow{9}{*}{Case II}
    & \multirow{3}{*}{1/50}  & 95  & \multirow{3}{*}{0.4654895} & $-0.008115$ ($-0.08\%$)   & \multirow{3}{*}{0.390341} & $-0.003967$ ($-0.04\%$)     \\
    &                         & 100 &                           & $-0.004082$ ($-0.06\%$)      &                           & $-0.006998$ ($-0.09\%$)     \\
    &                         & 105 &                           & $-0.002389$ ($-0.05\%$)     &                           & $-0.01131$ ($-0.23\%$)     \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/500} & 95 & \multirow{3}{*}{2.9798648}  & $-0.007585$ ($-0.07\%$)    & \multirow{3}{*}{3.3973758} & $0.01003$ ($0.10\%$)    \\
    &                         & 100 &                           & $-0.004103$ ($-0.06\%$)     &                           & $0.01372$ ($0.19\%$)     \\
    &                         & 105  &                           & $-0.004198$ ($-0.09\%$)      &                           & $0.01213$ ($0.25\%$)   \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/5000}& 95 & \multirow{3}{*}{29.5629414} & $-0.01347$ ($-0.13\%$)     & \multirow{3}{*}{48.5850875}& $-0.01355$ ($-0.13\%$)   \\
    &                         & 100 &                           & $-0.01213$ ($-0.16\%$)     &                           & $-0.01645$ ($-0.22\%$)    \\
    &                         & 105  &                           & $-0.01034$ ($-0.21\%$)    &                           & $-0.01676$ ($-0.34\%$)    \\
    \midrule
    \multirow{9}{*}{Case III}
    & \multirow{3}{*}{1/50}  & 95  & \multirow{3}{*}{0.3870248}  & $-0.07066$ ($-0.60\%$)   & \multirow{3}{*}{0.4423578} & $-0.0309$ ($-0.26\%$)     \\
    &                         & 100 &                           & $-0.05942$ ($-0.66\%$)     &                           & $-0.03312$ ($-0.37\%$)   \\
    &                         & 105 &                           & $-0.04726$ ($-0.70\%$)    &                           & $-0.03326$ ($-0.50\%$)     \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/500} & 95 & \multirow{3}{*}{2.8634368}  & $-0.01972$ ($-0.17\%$)  & \multirow{3}{*}{3.3736463} & $0.0145$ ($0.12\%$)   \\
    &                         & 100 &                           & $-0.0188$ ($-0.21\%$)   &                           & $0.01558$ ($0.17\%$)    \\
    &                         & 105  &                           & $-0.01699$ ($-0.25\%$)   &                           & $0.01341$ ($0.20\%$)   \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/5000}& 95 & \multirow{3}{*}{28.5484009}& $-0.03975$ ($-0.34\%$)  & \multirow{3}{*}{48.5172484} & $-0.02017$ ($-0.17\%$)   \\
    &                         & 100 &                           & $-0.03741$ ($-0.42\%$)   &                           & $-0.02275$ ($-0.25\%$)    \\
    &                         & 105  &                           & $-0.03466$ ($-0.52\%$)    &                           & $-0.02071$ ($-0.31\%$)   \\
    \midrule
    \multirow{15}{*}{Case IV}
    & \multirow{5}{*}{1/50}  & 47 & \multirow{5}{*}{0.1061546} & $0.003786$ ($0.05\%$)     & \multirow{5}{*}{0.1498051} & $-0.001109$ ($-0.02\%$)   \\
    ...
    \cmidrule(lr){2-7}
    & \multirow{5}{*}{1/500} & 47 & \multirow{5}{*}{0.6052142}  & $0.003103$ ($0.04\%$)    & \multirow{5}{*}{0.7028849} & $-0.004188$ ($-0.06\%$)      \\
    &                        & 48 &                          & $0.07058$ ($1.09\%$)  &                          & $0.06351$ ($0.98\%$)     \\
    &                        & 49 &                          & $0.003458$ ($0.06\%$)  &                          & $-0.003395$ ($-0.06\%$)     \\
    &                        & 50 &                          & $0.003327$ ($0.06\%$)  &                          & $-0.003306$ ($-0.06\%$)     \\
    &                        & 51 &                          & $0.00312$ ($0.06\%$)  &                          & $-0.003293$ ($-0.06\%$)     \\
    \cmidrule(lr){2-7}
    & \multirow{5}{*}{1/5000}& 47 & \multirow{5}{*}{5.7636176} & $0.002685$ ($0.04\%$)     & \multirow{5}{*}{10.0292335} & $-0.0007707$ ($-0.01\%$)   \\
...
\begin{table}[htbp]
  \centering
  \caption{Almost Exact Stepping Results (CaseV-VII)}
  \label{tab:almostexactstepping_part2}
  \resizebox{\textwidth}{!}{%
  \begin{tabular}{lclclclc}
    \toprule
    \multirow{2}{*}{Case} & \multirow{2}{*}{$dt$} & \multirow{2}{*}{Strike} 
    ...
    \midrule
    \multirow{9}{*}{Case V}
    & \multirow{3}{*}{1/50}  & 10  & \multirow{3}{*}{0.1103219} & $0.005225$ ($0.01\%$)   & \multirow{3}{*}{0.129903} & $0.0005075$ ($0.00\%$)     \\
    &                         & 20 &                           & $0.005325$ ($0.02\%$)      &                           & $0.0005554$ ($0.00\%$)     \\
    &                         & 40 &                           & $0.006362$ ($0.05\%$)     &                           & $0.0006675$ ($0.01\%$)     \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/500} & 10 & \multirow{3}{*}{0.5894391}  & $0.008478$ ($0.02\%$)    & \multirow{3}{*}{0.7007175} & $-0.001447$ ($-0.00\%$)    \\
    &                         & 20 &                           & $0.008528$ ($0.03\%$)     &                           & $-0.001399$ ($-0.00\%$)     \\
    &                         & 40  &                           & $0.006799$ ($0.06\%$)      &                           & $-0.002191$ ($-0.02\%$)   \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/5000}& 10 & \multirow{3}{*}{5.7201683} & $0.007159$ ($0.02\%$)     & \multirow{3}{*}{9.9833601}& $0.0006374$ ($0.00\%$)   \\
    &                         & 20 &                           & $0.007191$ ($0.02\%$)     &                           & $0.0006815$ ($0.00\%$)    \\
    &                         & 40  &                           & $0.005399$ ($0.05\%$)    &                           & $0.0009337$ ($0.01\%$)    \\
    \midrule
    \multirow{15}{*}{Case VI}
    & \multirow{5}{*}{1/50}  & 47  & \multirow{5}{*}{0.7873058}  & $36.17$ ($283.95\%$)   & \multirow{5}{*}{0.7045123} & $\inf$ ($\inf\%$)     \\
    &                         & 48 &                           & $36.17$ ($291.92\%$)     &                           & $\inf$ ($\inf\%$)   \\
    &                         & 49 &                           & $36.17$ ($300.01\%$)    &                           & $\inf$ ($\inf\%$)     \\
    &                         & 50 &                           & $36.17$ ($308.20\%$)    &                           & $\inf$ ($\inf\%$)     \\
    &                         & 51 &                           & $36.17$ ($316.52\%$)    &                           & $\inf$ ($\inf\%$)     \\
    \cmidrule(lr){2-7}
    & \multirow{5}{*}{1/500} & 47 & \multirow{5}{*}{5.8676512}  & $0.01475$ ($0.12\%$)  & \multirow{5}{*}{6.6754493} & $4.106e+68$ ($nan\%$)   \\
    &                         & 48 &                           & $0.01432$ ($0.12\%$)   &                           & $4.106e+68$ ($nan\%$)    \\
    &                         & 49  &                           & $0.01395$ ($0.12\%$)   &                           & $4.106e+68$ ($nan\%$)   \\
    &                         & 50 &                           & $0.01336$ ($0.11\%$)   &                           & $4.106e+68$ ($nan\%$)     \\
    &                         & 51 &                           & $0.01297$ ($0.11\%$)    &                           & $4.106e+68$ ($nan\%$)   \\
    \cmidrule(lr){2-7}
    & \multirow{5}{*}{1/5000}& 47 & \multirow{5}{*}{57.7701995}& $0.02753$ ($0.22\%$)  & \multirow{5}{*}{99.3793894} & $3.057e+21$ ($nan\%$)   \\
    ...
    \midrule
    \multirow{9}{*}{Case VII}
    & \multirow{3}{*}{1/50}  & 95  & \multirow{3}{*}{0.3766218}  & $-0.07016$ ($-0.60\%$)   & \multirow{3}{*}{0.3742216} & $-0.0304$ ($-0.26\%$)     \\
    &                         & 100 &                           & $-0.05822$ ($-0.65\%$)     &                           & $-0.03192$ ($-0.35\%$)   \\
    &                         & 105 &                           & $-0.04636$ ($-0.69\%$)    &                           & $-0.03236$ ($-0.48\%$)     \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/500} & 95 & \multirow{3}{*}{2.9082565}  & $-0.01922$ ($-0.16\%$)  & \multirow{3}{*}{3.36681} & $0.015$ ($0.13\%$)   \\
    &                         & 100 &                           & $-0.0176$ ($-0.20\%$)   &                           & $0.01678$ ($0.19\%$)    \\
    &                         & 105  &                           & $-0.01609$ ($-0.24\%$)   &                           & $0.01431$ ($0.21\%$)   \\
    \cmidrule(lr){2-7}
    & \multirow{3}{*}{1/5000}& 95 & \multirow{3}{*}{48.1214847}& $-0.03925$ ($-0.33\%$)  & \multirow{3}{*}{52.2054604} & $-0.01967$ ($-0.17\%$)   \\
